package com.xiechao.config.ds.second;
...
@Configuration
@Slf4j
@MapperScan(basePackages = "com.xiechao.mapper.second",sqlSessionTemplateRef ="secondSqlSessionTemplate")
public class SecondDataSourceConfig {
    ...
    /**本数据源扫描的mapper路径*/
    static final String MAPPER_LOCATION = "classpath:mapper/second/DemoMapper.xml";
    ...
    public DynamicDataSource createDataSource() {
        ...
        try {
            dynamicDataSource = new DynamicDataSource(dataSourceManager.createAndTestDataSource("spring.datasource.second"));
        } catch (SQLException e) {
            e.printStackTrace();
            log.info("create second datasource failed: {} ", e.getMessage());
        }
